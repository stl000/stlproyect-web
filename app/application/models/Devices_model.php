...
class Devices_model extends CI_Model
{
 ...
 //obtenemos la lista completa de dispositivos del usuario
  ...
  public function add_device($user_id,$device_alias,$device_serial_number)
  {
    //Comprobamos que tenga alias y numero de serie
    if($device_alias==null){
      return "empty alias";
    }else if($device_serial_number==null){
      return "empty sn";
    }
